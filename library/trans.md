...
<p style="text-indent: 0pt;"><b>Автор:</b> Nedzad Hadziefendic, Jovan Trifunovic, Nemanja Kostic, Marko Davidovic, Miomir Kostic<br>
...
(уменьшение момента затяжки), а также
...
уменьшения момента затяжки и увеличения
...
<p align="center"><img src="trans/5a25f7523bd5fde1.png" name="Изображение1"  width="483">
</img></p>
...
момента затяжки и увеличения оксидного
...
% и 15 %), и различные регулируемые
моменты затяжки на винтовых зажимах другого
